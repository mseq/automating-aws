...
class BucketManager:
    ...
    def all_objects(self, bucket_name):
        """Get an interator for all objects on a bucket."""
    ...
    def set_policy(self, bucket):
        ...
        policy = """
            {
                "Version": "2012-10-17",
                "Id": "Policy1566929372316",
                "Statement": [
                    {
                        "Sid": "Stmt1566929366354",
                        "Effect": "Allow",
                        "Principal": "*",
                        "Action": "s3:GetObject",
    ...
    def configure_website(self, bucket):
        """Enable the bucket to be a Static WebServer ."""
    ...
    def sync(self, pathname, bucket_name):
        """Copy the files from pathname to bucket_name."""
